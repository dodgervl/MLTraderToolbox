...
class UserWebsocketEngine:
    ...
    def main(self):
        def on_message(ws, message):
            ...
            if 'params' in message.keys() and message['params'][
                'type'] == 'heartbeat' and self.heartbeat_set_flag == 0:  # noqa: E501
            ...
            if message['id'] == 7617:
                ...
                for instrument in range(0, len(message['result'])):
                    subscribe_channel = "book." + str(
                        message['result'][instrument]['instrument_name']) + ".none.10.100ms"
